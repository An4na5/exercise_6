...
class Vehicle(object):
    ...
    def __init__(self,year,mileage,purchase_price,serial_number):
        if not isinstance(year, int) and isinstance(mileage, int) and isinstance(purchase_price, int):
            raise ValueError("Year, mileage and purchase price have to be integers!")
        self.__year = year
    ...
    def generate_vehicle_id():
        vehicle_id = Vehicle.vehicle_id + 100000
        return vehicle_id
